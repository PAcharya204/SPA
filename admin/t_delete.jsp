...
if(idParam==null)
{
    response.sendRedirect("view_teacher.jsp");
    return;
}
        ...
        <div id="main">
            <form method="post">
                ...
                <div class="warning-icon"></div>
                    ...
                    <p class="warning-text">You are about to permanently remove this teacher's account from the Student Performance Analysis System.
                    <br><br>
                ...
                <div class="button-group">
                    ...
                    <input type="submit" id="addbtn" value=" Delete Teacher">

                    <input type="button" id="backbtn" value=" Cancel" onclick="location.href='view_teacher.jsp'">
            ...
            <%
                if(request.getMethod().equalsIgnoreCase("POST"))
                {
                        try
                        {
                            ...
                            {
                                out.println(
                                "<script>alert('Teacher Deleted Successfully');window.location='view_teacher.jsp';</script>");
                            }
                            else
                            {
                                out.println(
                                "<script>alert('Teacher Not Deleted');</script>");
                            }
