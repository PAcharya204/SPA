...
<body>
   ...
   <form method="post" class="change-form">
        ...
        <p class="change-subtitle">Administrator Account Security</p>
        ...
        <div class="password-note">
            ...
            <a href="ad_profile.jsp" class="back-btn">
            Back
            </a>
            ...
            try
            {
                ...
                if(rs.next())
                {
                    ...
                    if(dbpass.equals(old))
                    {
                        ...
                        ps2.setString(1,np);
                        ps2.setString(2,admin_username);

                        int x=ps2.executeUpdate();

                        if(x>0)
                        {
                            out.println("<script>alert('Password Updated Successfully');window.location='ad_profile.jsp';</script>");
                        }
