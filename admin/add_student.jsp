...
<header>
    ...
    <div id="main">
        <div class="page-header">
            ...
            <p>
            Create a student account for the Student Performance Analysis System.
            </p>

        </div>
       <form action="../AddStudentServlet"method="post"enctype="multipart/form-data"class="form-card">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="upload-box">
                        ...
                        <img src="../images/default_stud.png" id="preview" class="upload-preview">

                        <input type="file" name="profile" accept="image/*" onchange="previewImage(event)"required>
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" name="rollno" placeholder="e.g. MCA24001"required>
            </div>
        </div>
        ...
        <div class="row">
           ...
           <div class="form-buttons">
                ...
                <input type="submit" value="Add Student" id="submit-btn">
