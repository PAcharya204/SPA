...
if(username!=null)
{
    ...
    else
    {
        try
        {
            PreparedStatement ps= con.prepareStatement("select * from student where s_username=? and s_password=?");
            ...
            if(rs.next())
            {
                ...
                out.println("<script>alert('Login Successful'); window.location='stud_dashboard.jsp';</script>");
            }
            else
            {
