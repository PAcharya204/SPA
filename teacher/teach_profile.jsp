...
<div id="sidebar">
 ...
 <div id="main">
                <%
                    try
                        {
                            PreparedStatement ps=con.prepareStatement("select * from teacher where t_username=?");
                            ps.setString(1,t_username);
                        ...
                        <div class="profile-card">
                            ...
                            <h2 class="profile-title"><%=rs.getString("t_name")%></h2>
                            ...
                            <div class="profile-buttons">
                                ...
                                <a href="teach_change_pass.jsp" class="action-btn">
                    ...
                    {
                        let choice=confirm(
                            "Do you really want to logout from the Teacher Panel?"
                        );

                        if(choice)
                        {
                            window.location="teach_logout.jsp";
                        }
                    }
                    </script>
