...
if(username!=null)
{
    ...
    else
    {
        try
        {
            PreparedStatement ps= con.prepareStatement("select * from teacher where t_username=? and t_password=?");
            ...
            if(rs.next())
            {
                ...
                out.println("<script>alert('Login Successful'); window.location='teach_dashboard.jsp';</script>");
            }
            else
            {
