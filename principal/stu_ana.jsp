...
<body>
    ...
    <div id="sidebar">
        ...
        <div><a href="view_student.jsp"><i class="fa-solid fa-user-graduate"></i>&nbsp;&nbsp;STUDENT DETAILS</a></div>
        <div><a href="tea_ana.jsp"><i class="fa-solid fa-chalkboard-user"></i>&nbsp;&nbsp;TEACHER DETAILS</a></div>
        <div><a href="dept_ana.jsp"><i class="fa-solid fa-user-graduate"></i>&nbsp;&nbsp;DEPARTMENT DETAILS</a></div>
    </div>
